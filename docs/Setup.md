...
5. Put [server.crt](./../assets/ssl/server.crt) and [server.crt](./../assets/ssl/server.key) provided in this repository in `C:\Apache24\conf`. Alternatively, you can generate your own OpenSSL certificate.
