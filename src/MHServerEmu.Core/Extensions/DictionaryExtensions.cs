...
namespace MHServerEmu.Core.Extensions
{
    public static class DictionaryExtensions
    {
        ...
        /// </summary>
        public static bool TryGetValueRef<TKey, TValue>(this Dictionary<TKey, TValue> dict, TKey key, ref TValue value)
        {
            value = ref CollectionsMarshal.GetValueRefOrNullRef(dict, key);
