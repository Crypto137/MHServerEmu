...
namespace MHServerEmu.Games.Regions
{
    public class RegionManager
    {
        ...
        private static byte[] GetArchiveData(RegionPrototypeId prototype)
        {
            ...
            RegionArchive archive = new(9000000);
            ...
            switch (prototype)
            {
                case RegionPrototypeId.NPEAvengersTowerHUBRegion:
                    ...
                    archive.MissionManager.InsertMission(new((PrototypeId)9033745879814514175, 0x64A2F98F));

                    // Missions/Prototypes/Hubs/AvengersTower/Discoveries/BenUrichAndJessicaJones.prototype
                    archive.MissionManager.InsertMission(new((PrototypeId)12163941636897120859, 0x7094021E));

                    // Missions/Prototypes/BonusMissions/WeeklyEventMissions/OmegaMissionVendorController.prototype
                    archive.MissionManager.InsertMission(new((PrototypeId)15923097160974411372, 0x5535A91E));

                    // Missions/Prototypes/BonusMissions/WeeklyEventMissions/ARMORWeekMissionController.prototype
                    archive.MissionManager.InsertMission(new((PrototypeId)16864913917856392610, 0x7297046B));
                ...
                case RegionPrototypeId.DangerRoomHubRegion:
                    ...
                    archive.Properties[PropertyEnum.DamageRegionPlayerToMob] = 0.3f;
                    archive.Properties[PropertyEnum.DifficultyTier] = (PrototypeId)DifficultyTier.Heroic;   // Difficulty/Tiers/Tier2Heroic.prototype
                    archive.Properties[PropertyEnum.ExperienceBonusPct] = 0.9f;
                    archive.Properties[PropertyEnum.LootBonusCreditsPct] = 0.9f;
                    archive.Properties[PropertyEnum.LootBonusXPPct] = 0.9f;
                ...
                case RegionPrototypeId.XManhattanRegion60Cosmic:
                    ...
                    archive.Properties[PropertyEnum.DamageRegionPlayerToMob] = 0.13f;
                    archive.Properties[PropertyEnum.DifficultyTier] = (PrototypeId)DifficultyTier.Superheroic;  // Difficulty/Tiers/Tier3Superheroic.prototype
                    archive.Properties[PropertyEnum.ExperienceBonusPct] = 2.4f;
                    archive.Properties[PropertyEnum.LootBonusCreditsPct] = 2.4f;
                    archive.Properties[PropertyEnum.LootBonusXPPct] = 2.4f;

                    #region Missions

                    archive.MissionManager.InsertMission(new(MissionState.Completed,
                        0x0,
                        (PrototypeId)3667304362440335589,   // Missions/Prototypes/PVEEndgame/PatrolMidtown/Events/MidtownEventNinjas.prototype
                        0x0,
                        new Objective[] { new(0x0, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x3, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x4, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));

                    archive.MissionManager.InsertMission(new(MissionState.Failed,
                        0x1257F4AA4CFA0,
                        ...
                        0x7912D38B,
                        new Objective[] { new(0x0, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        Array.Empty<ulong>(),
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Active,
                        0x0,
                        ...
                        0x62300577,
                        new Objective[] { new(0x0, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Available, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Completed,
                        ...
                        0x0,
                        new Objective[] { new(0x0, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x5, 0x5, 0x0, 0x0),
                            new(0x1, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Active,
                        ...
                        0x5957A7E7,
                        new Objective[] { new(0x0, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x14, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Failed,
                        ...
                        0x48F91EAB,
                        new Objective[] { new(0x0, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x3, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x4, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x5, MissionObjectiveState.Failed, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Completed,
                        ...
                        new Objective[] { new(0x0, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x3, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Active,
                        ...
                        new Objective[] { new(0x0, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Available, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Available, 0x0, Array.Empty<InteractionTag>(), 0x3, 0x3, 0x0, 0x0) },
                        Array.Empty<ulong>(),
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Active,
                        ...
                        new Objective[] { new(0x0, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Available, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Available, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        Array.Empty<ulong>(),
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Active,
                        ...
                        0x39D7DF60,
                        new Objective[] { new(0x0, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x2, 0x4, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Active, 0x1257F597AB940, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Completed,
                        ...
                        new Objective[] { new(0x0, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            ...
                            new(0x2, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x3, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x4, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x5, MissionObjectiveState.Completed, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x6, MissionObjectiveState.Invalid, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));

                    archive.MissionManager.InsertMission(new(MissionState.Inactive,
                        0x0,
                    ...
                    archive.MissionManager.InsertMission(new(MissionState.Active,
                        ...
                        0x33D3263B,
                        new Objective[] { new(0x0, MissionObjectiveState.Skipped, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, MissionObjectiveState.Skipped, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, MissionObjectiveState.Active, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
