        ...
        private static byte[] GetArchiveData(RegionPrototypeId prototype)
        {
            ...
            switch (prototype)
            {
                ...
                case RegionPrototypeId.XManhattanRegion60Cosmic:
                    ...
                    archive.MissionManager.InsertMission(new(0x8,
                        0x0,
                        (PrototypeId)3667304362440335589,   // Missions/Prototypes/PVEEndgame/PatrolMidtown/Events/MidtownEventNinjas.prototype
                        0x0,
                        new Objective[] { new(0x0, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x1, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x2, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x3, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x4, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));

                    archive.MissionManager.InsertMission(new(0xA,
                        0x1257F4AA4CFA0,
                    ...
                    archive.MissionManager.InsertMission(new(0x6,
                        0x0,
                        ...
                        0x62300577,
                        new Objective[] { new(0x0, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, 0x1, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                    ...
                    archive.MissionManager.InsertMission(new(0x8,
                        ...
                        0x0,
                        new Objective[] { new(0x0, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x5, 0x5, 0x0, 0x0),
                    ...
                    archive.MissionManager.InsertMission(new(0x6,
                        ...
                        0x5957A7E7,
                        new Objective[] { new(0x0, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x14, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(0xA,
                        ...
                        0x48F91EAB,
                        new Objective[] { new(0x0, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x1, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x2, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x3, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x4, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x1, 0x0, 0x0),
                            new(0x5, 0x4, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(0x8,
                        ...
                        new Objective[] { new(0x0, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x1, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x2, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x3, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(0x6,
                        ...
                        new Objective[] { new(0x0, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, 0x1, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, 0x1, 0x0, Array.Empty<InteractionTag>(), 0x3, 0x3, 0x0, 0x0) },
                        Array.Empty<ulong>(),
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(0x6,
                        ...
                        new Objective[] { new(0x0, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, 0x1, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, 0x1, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        Array.Empty<ulong>(),
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(0x6,
                        ...
                        0x39D7DF60,
                        new Objective[] { new(0x0, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x1, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x2, 0x4, 0x0, 0x0),
                            new(0x2, 0x2, 0x1257F597AB940, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));
                    ...
                    archive.MissionManager.InsertMission(new(0x8,
                        ...
                        new Objective[] { new(0x0, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            ...
                            new(0x2, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x3, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x4, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x5, 0x3, 0x0, Array.Empty<InteractionTag>(), 0x1, 0x1, 0x0, 0x0),
                            new(0x6, 0x0, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
                        new ulong[] { 491876, 516140, 535777, 545031, 547169, 561178, 572318, 573260, 579997, 594073, 596593, 600031, 601433, 609423, },
                        false));

                    archive.MissionManager.InsertMission(new(0x2,
                        0x0,
                    ...
                    archive.MissionManager.InsertMission(new(0x6,
                        ...
                        0x33D3263B,
                        new Objective[] { new(0x0, 0x5, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x1, 0x5, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0),
                            new(0x2, 0x2, 0x0, Array.Empty<InteractionTag>(), 0x0, 0x0, 0x0, 0x0) },
