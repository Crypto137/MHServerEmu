...
namespace Gazillion {
  ...
  public static partial class FrontendProtocol {
    ...
    internal static pbd::MessageDescriptor internal__static_Gazillion_ErrorInfoLogEntry__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::Gazillion.ErrorInfoLogEntry, global::Gazillion.ErrorInfoLogEntry.Builder> internal__static_Gazillion_ErrorInfoLogEntry__FieldAccessorTable;
    ...
    static FrontendProtocol() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "UgxJc0NvbnN1bWFibGUiSQoRRXJyb3JJbmZvTG9nRW50cnkSGgoIQ2F0ZWdv", 
            "cnkYASABKAlSCENhdGVnb3J5EhgKB0RldGFpbHMYAiABKAlSB0RldGFpbHMi", 
            "6gIKEExvZ2luRGF0YUNvbnNvbGUSFAoFdG9rZW4YASACKAlSBXRva2VuEhgK", 
            "B3ZlcnNpb24YAiABKAlSB3ZlcnNpb24SOgoYbm9QZXJzaXN0ZW5jZVRoaXNT", 
            "ZXNzaW9uGAMgASgIUhhub1BlcnNpc3RlbmNlVGhpc1Nlc3Npb24SVgoTc2Vy", 
            "dmljZUVudGl0bGVtZW50cxgEIAMoCzIkLkdhemlsbGlvbi5Db25zb2xlU2Vy", 
            "dmljZUVudGl0bGVtZW50UhNzZXJ2aWNlRW50aXRsZW1lbnRzEhgKB3RpdGxl", 
            "aWQYBSABKAlSB3RpdGxlaWQSFAoFZW52aWQYBiABKAlSBWVudmlkEiAKC2Nv", 
            "bnNvbGV0eXBlGAcgASgJUgtjb25zb2xldHlwZRJACgxlcnJvcmluZm9sb2cY", 
            "CCADKAsyHC5HYXppbGxpb24uRXJyb3JJbmZvTG9nRW50cnlSDGVycm9yaW5m", 
            "b2xvZyK4AQoUQ3JlYXRlQWNjb3VudENvbnNvbGUSFAoFdG9rZW4YASACKAlS", 
            "BXRva2VuEhgKB3ZlcnNpb24YAiABKAlSB3ZlcnNpb24SHgoKcGxheWVybmFt", 
            "ZRgDIAIoCVIKcGxheWVybmFtZRIYCgd0aXRsZWlkGAQgASgJUgd0aXRsZWlk", 
            "EhQKBWVudmlkGAUgASgJUgVlbnZpZBIgCgtjb25zb2xldHlwZRgGIAEoCVIL", 
            "Y29uc29sZXR5cGUisQEKD0FjY2VwdERvY3VtZW50cxIUCgV0b2tlbhgBIAIo", 
            "CVIFdG9rZW4SGAoHdmVyc2lvbhgCIAEoCVIHdmVyc2lvbhIcCglkb2N1bWVu", 
            "dHMYAyADKAlSCWRvY3VtZW50cxIYCgd0aXRsZWlkGAQgASgJUgd0aXRsZWlk", 
            "EhQKBWVudmlkGAUgASgJUgVlbnZpZBIgCgtjb25zb2xldHlwZRgGIAEoCVIL", 
            "Y29uc29sZXR5cGUiYgoQU2VsZWN0UGxheWVyTmFtZRIUCgV0b2tlbhgBIAIo", 
            "CVIFdG9rZW4SGAoHdmVyc2lvbhgCIAEoCVIHdmVyc2lvbhIeCgpwbGF5ZXJu", 
            "YW1lGAMgAigJUgpwbGF5ZXJuYW1lIrUBChZJbml0aWFsQ2xpZW50SGFuZHNo", 
            "YWtlEl0KD3Byb3RvY29sVmVyc2lvbhgBIAIoDjIiLkdhemlsbGlvbi5Gcm9u", 
            "dGVuZFByb3RvY29sVmVyc2lvbjoPQ1VSUkVOVF9WRVJTSU9OUg9wcm90b2Nv", 
            "bFZlcnNpb24SPAoKc2VydmVyVHlwZRgCIAIoDjIcLkdhemlsbGlvbi5QdWJT", 
            "dWJTZXJ2ZXJUeXBlc1IKc2VydmVyVHlwZSLhAQoRQ2xpZW50Q3JlZGVudGlh", 
            "bHMSHAoJc2Vzc2lvbmlkGAEgAigEUglzZXNzaW9uaWQSDgoCaXYYAiACKAxS", 
            "Aml2EiYKDmVuY3J5cHRlZFRva2VuGAMgAigMUg5lbmNyeXB0ZWRUb2tlbhIy", 
            "ChRlbmNyeXB0ZWRDbGllbnRUb2tlbhgEIAEoDFIUZW5jcnlwdGVkQ2xpZW50", 
            "VG9rZW4SQgocdm9pY2VTZXNzaW9uRW5jcnlwdGlvbkFFU0tleRgFIAEoDFIc", 
            "dm9pY2VTZXNzaW9uRW5jcnlwdGlvbkFFU0tleSJqChBMb2dpblF1ZXVlU3Rh", 
            "dHVzEiAKC3BsYWNlSW5MaW5lGAEgAigEUgtwbGFjZUluTGluZRI0ChVudW1i", 
            "ZXJPZlBsYXllcnNJbkxpbmUYAiACKARSFW51bWJlck9mUGxheWVyc0luTGlu", 
            "ZSKsAQoYU2Vzc2lvbkVuY3J5cHRpb25DaGFuZ2VkEi8KEXJhbmRvbU51bWJl", 
            "ckluZGV4GAEgAigNOgExUhFyYW5kb21OdW1iZXJJbmRleBI0ChVlbmNyeXB0", 
            "ZWRSYW5kb21OdW1iZXIYAiACKAxSFWVuY3J5cHRlZFJhbmRvbU51bWJlchIp", 
            "Cg5jbGllbnRUb2tlbkNSQxgDIAEoDToBMFIOY2xpZW50VG9rZW5DUkMiSgoS", 
            "RXh0ZW5kZWRMb2dpbkVycm9yEjQKBWVycm9yGAEgASgOMh4uR2F6aWxsaW9u", 
            "LkV4dGVuZGVkTG9naW5FcnJvcnNSBWVycm9yInIKFkVuY3J5cHRlZFRyYWZm", 
            "aWNIZWFkZXISLAoRcmFuZG9tTnVtYmVySW5kZXgYASACKA1SEXJhbmRvbU51", 
            "bWJlckluZGV4EioKEGVuY3J5cHRlZFRyYWZmaWMYAiACKAxSEGVuY3J5cHRl", 
            "ZFRyYWZmaWMiKQoPUHJlY2FjaGVIZWFkZXJzEhYKBmxvY2FsZRgBIAIoCVIG", 
            "bG9jYWxlIiUKC05ld3NSZXF1ZXN0EhYKBmxvY2FsZRgBIAIoCVIGbG9jYWxl", 
            "Ki4KF0Zyb250ZW5kUHJvdG9jb2xWZXJzaW9uEhMKD0NVUlJFTlRfVkVSU0lP", 
            "ThABKksKE0V4dGVuZGVkTG9naW5FcnJvcnMSEgoOTk9fTE9HSU5fRVJST1IQ", 
          "ABIgChxDTElFTlRfTUFOQUdFUl9OT1RfQVZBSUxBQkxFEAE="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Gazillion_ErrorInfoLogEntry__Descriptor = Descriptor.MessageTypes[2];
        internal__static_Gazillion_ErrorInfoLogEntry__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.ErrorInfoLogEntry, global::Gazillion.ErrorInfoLogEntry.Builder>(internal__static_Gazillion_ErrorInfoLogEntry__Descriptor,
                new string[] { "Category", "Details", });
        internal__static_Gazillion_LoginDataConsole__Descriptor = Descriptor.MessageTypes[3];
        internal__static_Gazillion_LoginDataConsole__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.LoginDataConsole, global::Gazillion.LoginDataConsole.Builder>(internal__static_Gazillion_LoginDataConsole__Descriptor,
                new string[] { "Token", "Version", "NoPersistenceThisSession", "ServiceEntitlements", "Titleid", "Envid", "Consoletype", "Errorinfolog", });
        internal__static_Gazillion_CreateAccountConsole__Descriptor = Descriptor.MessageTypes[4];
        internal__static_Gazillion_CreateAccountConsole__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.CreateAccountConsole, global::Gazillion.CreateAccountConsole.Builder>(internal__static_Gazillion_CreateAccountConsole__Descriptor,
                new string[] { "Token", "Version", "Playername", "Titleid", "Envid", "Consoletype", });
        internal__static_Gazillion_AcceptDocuments__Descriptor = Descriptor.MessageTypes[5];
        internal__static_Gazillion_AcceptDocuments__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.AcceptDocuments, global::Gazillion.AcceptDocuments.Builder>(internal__static_Gazillion_AcceptDocuments__Descriptor,
                new string[] { "Token", "Version", "Documents", "Titleid", "Envid", "Consoletype", });
        internal__static_Gazillion_SelectPlayerName__Descriptor = Descriptor.MessageTypes[6];
        ...
        internal__static_Gazillion_InitialClientHandshake__Descriptor = Descriptor.MessageTypes[7];
        ...
        internal__static_Gazillion_ClientCredentials__Descriptor = Descriptor.MessageTypes[8];
        internal__static_Gazillion_ClientCredentials__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.ClientCredentials, global::Gazillion.ClientCredentials.Builder>(internal__static_Gazillion_ClientCredentials__Descriptor,
                new string[] { "Sessionid", "Iv", "EncryptedToken", "EncryptedClientToken", "VoiceSessionEncryptionAESKey", });
        internal__static_Gazillion_LoginQueueStatus__Descriptor = Descriptor.MessageTypes[9];
        ...
        internal__static_Gazillion_SessionEncryptionChanged__Descriptor = Descriptor.MessageTypes[10];
        internal__static_Gazillion_SessionEncryptionChanged__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.SessionEncryptionChanged, global::Gazillion.SessionEncryptionChanged.Builder>(internal__static_Gazillion_SessionEncryptionChanged__Descriptor,
                new string[] { "RandomNumberIndex", "EncryptedRandomNumber", "ClientTokenCRC", });
        internal__static_Gazillion_ExtendedLoginError__Descriptor = Descriptor.MessageTypes[11];
        internal__static_Gazillion_ExtendedLoginError__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.ExtendedLoginError, global::Gazillion.ExtendedLoginError.Builder>(internal__static_Gazillion_ExtendedLoginError__Descriptor,
                new string[] { "Error", });
        internal__static_Gazillion_EncryptedTrafficHeader__Descriptor = Descriptor.MessageTypes[12];
        ...
        internal__static_Gazillion_PrecacheHeaders__Descriptor = Descriptor.MessageTypes[13];
        internal__static_Gazillion_PrecacheHeaders__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.PrecacheHeaders, global::Gazillion.PrecacheHeaders.Builder>(internal__static_Gazillion_PrecacheHeaders__Descriptor,
                new string[] { "Locale", });
        internal__static_Gazillion_NewsRequest__Descriptor = Descriptor.MessageTypes[14];
  ...
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  public sealed partial class ErrorInfoLogEntry : pb::GeneratedMessage<ErrorInfoLogEntry, ErrorInfoLogEntry.Builder> {
    private ErrorInfoLogEntry() { }
    private static readonly ErrorInfoLogEntry defaultInstance = new ErrorInfoLogEntry().MakeReadOnly();
    private static readonly string[] _errorInfoLogEntryFieldNames = new string[] { "Category", "Details" };
    private static readonly uint[] _errorInfoLogEntryFieldTags = new uint[] { 10, 18 };
    public static ErrorInfoLogEntry DefaultInstance {
      get { return defaultInstance; }
    }
    
    public override ErrorInfoLogEntry DefaultInstanceForType {
      get { return DefaultInstance; }
    }
    
    protected override ErrorInfoLogEntry ThisMessage {
      get { return this; }
    }
    
    public static pbd::MessageDescriptor Descriptor {
      get { return global::Gazillion.FrontendProtocol.internal__static_Gazillion_ErrorInfoLogEntry__Descriptor; }
    }
    
    protected override pb::FieldAccess.FieldAccessorTable<ErrorInfoLogEntry, ErrorInfoLogEntry.Builder> InternalFieldAccessors {
      get { return global::Gazillion.FrontendProtocol.internal__static_Gazillion_ErrorInfoLogEntry__FieldAccessorTable; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      CalcSerializedSize();
      string[] field_names = _errorInfoLogEntryFieldNames;
      if (hasCategory) {
        output.WriteString(1, field_names[0], Category);
      }
      if (hasDetails) {
        output.WriteString(2, field_names[1], Details);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasDetails) {
        size += pb::CodedOutputStream.ComputeStringSize(2, Details);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
    }
    public static ErrorInfoLogEntry ParseFrom(pb::ByteString data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(pb::ByteString data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(byte[] data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(byte[] data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(global::System.IO.Stream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseDelimitedFrom(global::System.IO.Stream input) {
      return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseDelimitedFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(pb::ICodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static ErrorInfoLogEntry ParseFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    private ErrorInfoLogEntry MakeReadOnly() {
      return this;
    }
    ...
    public override Builder ToBuilder() { return CreateBuilder(this); }
    public override Builder CreateBuilderForType() { return new Builder(); }
    public static Builder CreateBuilder(ErrorInfoLogEntry prototype) {
      return new Builder(prototype);
    }
    
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    public sealed partial class Builder : pb::GeneratedBuilder<ErrorInfoLogEntry, Builder> {
      protected override Builder ThisBuilder {
        get { return this; }
      }
      public Builder() {
      ...
      internal Builder(ErrorInfoLogEntry cloneFrom) {
        result = cloneFrom;
        resultIsReadOnly = true;
      }
      
      private bool resultIsReadOnly;
      private ErrorInfoLogEntry result;
      
      private ErrorInfoLogEntry PrepareBuilder() {
        if (resultIsReadOnly) {
          ErrorInfoLogEntry original = result;
          result = new ErrorInfoLogEntry();
          resultIsReadOnly = false;
          MergeFrom(original);
        }
        return result;
      ...
      protected override ErrorInfoLogEntry MessageBeingBuilt {
        get { return PrepareBuilder(); }
      }
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::Gazillion.ErrorInfoLogEntry.Descriptor; }
      }
      
      public override ErrorInfoLogEntry DefaultInstanceForType {
        get { return global::Gazillion.ErrorInfoLogEntry.DefaultInstance; }
      }
      
      public override ErrorInfoLogEntry BuildPartial() {
        if (resultIsReadOnly) {
          return result;
        }
        resultIsReadOnly = true;
      ...
      public override Builder MergeFrom(pb::IMessage other) {
        if (other is ErrorInfoLogEntry) {
          return MergeFrom((ErrorInfoLogEntry) other);
        } else {
          base.MergeFrom(other);
          return this;
        }
      ...
      public override Builder MergeFrom(ErrorInfoLogEntry other) {
        if (other == global::Gazillion.ErrorInfoLogEntry.DefaultInstance) return this;
        PrepareBuilder();
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          if(tag == 0 && field_name != null) {
            int field_ordinal = global::System.Array.BinarySearch(_errorInfoLogEntryFieldNames, field_name, global::System.StringComparer.Ordinal);
            if(field_ordinal >= 0)
              tag = _errorInfoLogEntryFieldTags[field_ordinal];
            else {
              if (unknownFields == null) {
                unknownFields = pb::UnknownFieldSet.CreateBuilder(this.UnknownFields);
              }
          ...
          switch (tag) {
            ...
            case 18: {
              result.hasDetails = input.ReadString(ref result.details_);
              break;
            }
          }
        }
      ...
      public bool HasDetails {
        get { return result.hasDetails; }
      }
      public string Details {
        get { return result.Details; }
  ...
  public sealed partial class LoginDataConsole : pb::GeneratedMessage<LoginDataConsole, LoginDataConsole.Builder> {
    ...
    private static readonly string[] _loginDataConsoleFieldNames = new string[] { "consoletype", "envid", "errorinfolog", "noPersistenceThisSession", "serviceEntitlements", "titleid", "token", "version" };
    private static readonly uint[] _loginDataConsoleFieldTags = new uint[] { 58, 50, 66, 24, 34, 42, 10, 18 };
    ...
    public const int EnvidFieldNumber = 6;
    private bool hasEnvid;
    private string envid_ = "";
    public bool HasEnvid {
      get { return hasEnvid; }
    }
    public string Envid {
      get { return envid_; }
    ...
    public const int ConsoletypeFieldNumber = 7;
    private bool hasConsoletype;
    private string consoletype_ = "";
    public bool HasConsoletype {
      get { return hasConsoletype; }
    }
    public string Consoletype {
      get { return consoletype_; }
    }
    
    public const int ErrorinfologFieldNumber = 8;
    private pbc::PopsicleList<global::Gazillion.ErrorInfoLogEntry> errorinfolog_ = new pbc::PopsicleList<global::Gazillion.ErrorInfoLogEntry>();
    public scg::IList<global::Gazillion.ErrorInfoLogEntry> ErrorinfologList {
      get { return errorinfolog_; }
    }
    public int ErrorinfologCount {
      get { return errorinfolog_.Count; }
    }
    public global::Gazillion.ErrorInfoLogEntry GetErrorinfolog(int index) {
      return errorinfolog_[index];
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasVersion) {
        output.WriteString(2, field_names[7], Version);
      }
      if (hasNoPersistenceThisSession) {
        output.WriteBool(3, field_names[3], NoPersistenceThisSession);
      }
      if (serviceEntitlements_.Count > 0) {
        output.WriteMessageArray(4, field_names[4], serviceEntitlements_);
      }
      if (hasTitleid) {
        output.WriteString(5, field_names[5], Titleid);
      }
      if (hasEnvid) {
        output.WriteString(6, field_names[1], Envid);
      }
      if (hasConsoletype) {
        output.WriteString(7, field_names[0], Consoletype);
      }
      if (errorinfolog_.Count > 0) {
        output.WriteMessageArray(8, field_names[2], errorinfolog_);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasEnvid) {
        size += pb::CodedOutputStream.ComputeStringSize(6, Envid);
      }
      if (hasConsoletype) {
        size += pb::CodedOutputStream.ComputeStringSize(7, Consoletype);
      }
      foreach (global::Gazillion.ErrorInfoLogEntry element in ErrorinfologList) {
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<LoginDataConsole, Builder> {
      ...
      public override Builder MergeFrom(LoginDataConsole other) {
        ...
        if (other.HasConsoletype) {
          Consoletype = other.Consoletype;
        }
        if (other.errorinfolog_.Count != 0) {
          result.errorinfolog_.Add(other.errorinfolog_);
        }
        this.MergeUnknownFields(other.UnknownFields);
        return this;
      }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 50: {
              result.hasEnvid = input.ReadString(ref result.envid_);
              break;
            }
            case 58: {
              result.hasConsoletype = input.ReadString(ref result.consoletype_);
              break;
            }
            case 66: {
              input.ReadMessageArray(tag, field_name, result.errorinfolog_, global::Gazillion.ErrorInfoLogEntry.DefaultInstance, extensionRegistry);
              break;
            }
          }
        }
      ...
      public bool HasEnvid {
        get { return result.hasEnvid; }
      }
      public string Envid {
        get { return result.Envid; }
        set { SetEnvid(value); }
      }
      public Builder SetEnvid(string value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.hasEnvid = true;
        result.envid_ = value;
        return this;
      }
      public Builder ClearEnvid() {
        PrepareBuilder();
        result.hasEnvid = false;
        result.envid_ = "";
        return this;
      }
      
      public bool HasConsoletype {
        get { return result.hasConsoletype; }
      }
      public string Consoletype {
        get { return result.Consoletype; }
        set { SetConsoletype(value); }
      }
      public Builder SetConsoletype(string value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.hasConsoletype = true;
        result.consoletype_ = value;
        return this;
      }
      public Builder ClearConsoletype() {
        PrepareBuilder();
        result.hasConsoletype = false;
        result.consoletype_ = "";
        return this;
      }
      
      public pbc::IPopsicleList<global::Gazillion.ErrorInfoLogEntry> ErrorinfologList {
        get { return PrepareBuilder().errorinfolog_; }
      }
      public int ErrorinfologCount {
        get { return result.ErrorinfologCount; }
      }
      public global::Gazillion.ErrorInfoLogEntry GetErrorinfolog(int index) {
        return result.GetErrorinfolog(index);
      }
      public Builder SetErrorinfolog(int index, global::Gazillion.ErrorInfoLogEntry value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.errorinfolog_[index] = value;
        return this;
      }
      public Builder SetErrorinfolog(int index, global::Gazillion.ErrorInfoLogEntry.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.errorinfolog_[index] = builderForValue.Build();
        return this;
      }
      public Builder AddErrorinfolog(global::Gazillion.ErrorInfoLogEntry value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.errorinfolog_.Add(value);
        return this;
      }
      public Builder AddErrorinfolog(global::Gazillion.ErrorInfoLogEntry.Builder builderForValue) {
        pb::ThrowHelper.ThrowIfNull(builderForValue, "builderForValue");
        PrepareBuilder();
        result.errorinfolog_.Add(builderForValue.Build());
        return this;
      }
      public Builder AddRangeErrorinfolog(scg::IEnumerable<global::Gazillion.ErrorInfoLogEntry> values) {
        PrepareBuilder();
        result.errorinfolog_.Add(values);
        return this;
      }
      public Builder ClearErrorinfolog() {
        PrepareBuilder();
        result.errorinfolog_.Clear();
        return this;
      }
    }
  ...
  public sealed partial class CreateAccountConsole : pb::GeneratedMessage<CreateAccountConsole, CreateAccountConsole.Builder> {
    ...
    private static readonly string[] _createAccountConsoleFieldNames = new string[] { "consoletype", "envid", "playername", "titleid", "token", "version" };
    private static readonly uint[] _createAccountConsoleFieldTags = new uint[] { 50, 42, 26, 34, 10, 18 };
    ...
    public const int EnvidFieldNumber = 5;
    private bool hasEnvid;
    private string envid_ = "";
    public bool HasEnvid {
      get { return hasEnvid; }
    ...
    public const int ConsoletypeFieldNumber = 6;
    private bool hasConsoletype;
    private string consoletype_ = "";
    public bool HasConsoletype {
      get { return hasConsoletype; }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasToken) {
        output.WriteString(1, field_names[4], Token);
      }
      if (hasVersion) {
        output.WriteString(2, field_names[5], Version);
      }
      if (hasPlayername) {
        output.WriteString(3, field_names[2], Playername);
      }
      if (hasTitleid) {
        output.WriteString(4, field_names[3], Titleid);
      }
      if (hasEnvid) {
        output.WriteString(5, field_names[1], Envid);
      }
      if (hasConsoletype) {
        output.WriteString(6, field_names[0], Consoletype);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasTitleid) {
        size += pb::CodedOutputStream.ComputeStringSize(4, Titleid);
      }
      if (hasEnvid) {
        size += pb::CodedOutputStream.ComputeStringSize(5, Envid);
      }
      if (hasConsoletype) {
        size += pb::CodedOutputStream.ComputeStringSize(6, Consoletype);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
  ...
  public sealed partial class AcceptDocuments : pb::GeneratedMessage<AcceptDocuments, AcceptDocuments.Builder> {
    ...
    private static readonly string[] _acceptDocumentsFieldNames = new string[] { "consoletype", "documents", "envid", "titleid", "token", "version" };
    private static readonly uint[] _acceptDocumentsFieldTags = new uint[] { 50, 26, 42, 34, 10, 18 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasEnvid) {
        output.WriteString(5, field_names[2], Envid);
      }
      if (hasConsoletype) {
        output.WriteString(6, field_names[0], Consoletype);
      }
  ...
  public sealed partial class ClientCredentials : pb::GeneratedMessage<ClientCredentials, ClientCredentials.Builder> {
    ...
    private static readonly string[] _clientCredentialsFieldNames = new string[] { "encryptedClientToken", "encryptedToken", "iv", "sessionid", "voiceSessionEncryptionAESKey" };
    private static readonly uint[] _clientCredentialsFieldTags = new uint[] { 34, 26, 18, 8, 42 };
    ...
    public const int EncryptedClientTokenFieldNumber = 4;
    private bool hasEncryptedClientToken;
    private pb::ByteString encryptedClientToken_ = pb::ByteString.Empty;
    public bool HasEncryptedClientToken {
      get { return hasEncryptedClientToken; }
    }
    public pb::ByteString EncryptedClientToken {
      get { return encryptedClientToken_; }
    }
    
    public const int VoiceSessionEncryptionAESKeyFieldNumber = 5;
    private bool hasVoiceSessionEncryptionAESKey;
    private pb::ByteString voiceSessionEncryptionAESKey_ = pb::ByteString.Empty;
    public bool HasVoiceSessionEncryptionAESKey {
      get { return hasVoiceSessionEncryptionAESKey; }
    }
    public pb::ByteString VoiceSessionEncryptionAESKey {
      get { return voiceSessionEncryptionAESKey_; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasSessionid) {
        output.WriteUInt64(1, field_names[3], Sessionid);
      }
      if (hasIv) {
        output.WriteBytes(2, field_names[2], Iv);
      }
      if (hasEncryptedToken) {
        output.WriteBytes(3, field_names[1], EncryptedToken);
      }
      if (hasEncryptedClientToken) {
        output.WriteBytes(4, field_names[0], EncryptedClientToken);
      }
      if (hasVoiceSessionEncryptionAESKey) {
        output.WriteBytes(5, field_names[4], VoiceSessionEncryptionAESKey);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasEncryptedClientToken) {
        size += pb::CodedOutputStream.ComputeBytesSize(4, EncryptedClientToken);
      }
      if (hasVoiceSessionEncryptionAESKey) {
        size += pb::CodedOutputStream.ComputeBytesSize(5, VoiceSessionEncryptionAESKey);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<ClientCredentials, Builder> {
      ...
      public override Builder MergeFrom(ClientCredentials other) {
        ...
        if (other.HasEncryptedClientToken) {
          EncryptedClientToken = other.EncryptedClientToken;
        }
        if (other.HasVoiceSessionEncryptionAESKey) {
          VoiceSessionEncryptionAESKey = other.VoiceSessionEncryptionAESKey;
        }
        this.MergeUnknownFields(other.UnknownFields);
        return this;
      }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 34: {
              result.hasEncryptedClientToken = input.ReadBytes(ref result.encryptedClientToken_);
              break;
            }
            case 42: {
              result.hasVoiceSessionEncryptionAESKey = input.ReadBytes(ref result.voiceSessionEncryptionAESKey_);
              break;
            }
          }
        }
      ...
      public bool HasEncryptedClientToken {
        get { return result.hasEncryptedClientToken; }
      }
      public pb::ByteString EncryptedClientToken {
        get { return result.EncryptedClientToken; }
        set { SetEncryptedClientToken(value); }
      }
      public Builder SetEncryptedClientToken(pb::ByteString value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.hasEncryptedClientToken = true;
        result.encryptedClientToken_ = value;
        return this;
      }
      public Builder ClearEncryptedClientToken() {
        PrepareBuilder();
        result.hasEncryptedClientToken = false;
        result.encryptedClientToken_ = pb::ByteString.Empty;
        return this;
      }
      
      public bool HasVoiceSessionEncryptionAESKey {
        get { return result.hasVoiceSessionEncryptionAESKey; }
      }
      public pb::ByteString VoiceSessionEncryptionAESKey {
        get { return result.VoiceSessionEncryptionAESKey; }
        set { SetVoiceSessionEncryptionAESKey(value); }
      }
      public Builder SetVoiceSessionEncryptionAESKey(pb::ByteString value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        result.hasVoiceSessionEncryptionAESKey = true;
        result.voiceSessionEncryptionAESKey_ = value;
        return this;
      }
      public Builder ClearVoiceSessionEncryptionAESKey() {
        PrepareBuilder();
        result.hasVoiceSessionEncryptionAESKey = false;
        result.voiceSessionEncryptionAESKey_ = pb::ByteString.Empty;
        return this;
      }
    }
  ...
  public sealed partial class SessionEncryptionChanged : pb::GeneratedMessage<SessionEncryptionChanged, SessionEncryptionChanged.Builder> {
    ...
    private static readonly string[] _sessionEncryptionChangedFieldNames = new string[] { "clientTokenCRC", "encryptedRandomNumber", "randomNumberIndex" };
    private static readonly uint[] _sessionEncryptionChangedFieldTags = new uint[] { 24, 18, 8 };
    ...
    public const int ClientTokenCRCFieldNumber = 3;
    private bool hasClientTokenCRC;
    private uint clientTokenCRC_;
    public bool HasClientTokenCRC {
      get { return hasClientTokenCRC; }
    }
    public uint ClientTokenCRC {
      get { return clientTokenCRC_; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasRandomNumberIndex) {
        output.WriteUInt32(1, field_names[2], RandomNumberIndex);
      }
      if (hasEncryptedRandomNumber) {
        output.WriteBytes(2, field_names[1], EncryptedRandomNumber);
      }
      if (hasClientTokenCRC) {
        output.WriteUInt32(3, field_names[0], ClientTokenCRC);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasClientTokenCRC) {
        size += pb::CodedOutputStream.ComputeUInt32Size(3, ClientTokenCRC);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<SessionEncryptionChanged, Builder> {
      ...
      public override Builder MergeFrom(SessionEncryptionChanged other) {
        ...
        if (other.HasClientTokenCRC) {
          ClientTokenCRC = other.ClientTokenCRC;
        }
        this.MergeUnknownFields(other.UnknownFields);
        return this;
      }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 24: {
              result.hasClientTokenCRC = input.ReadUInt32(ref result.clientTokenCRC_);
              break;
            }
          }
        }
      ...
      public bool HasClientTokenCRC {
        get { return result.hasClientTokenCRC; }
      }
      public uint ClientTokenCRC {
        get { return result.ClientTokenCRC; }
        set { SetClientTokenCRC(value); }
      }
      public Builder SetClientTokenCRC(uint value) {
        PrepareBuilder();
        result.hasClientTokenCRC = true;
        result.clientTokenCRC_ = value;
        return this;
      }
      public Builder ClearClientTokenCRC() {
        PrepareBuilder();
        result.hasClientTokenCRC = false;
        result.clientTokenCRC_ = 0;
        return this;
      }
    }
