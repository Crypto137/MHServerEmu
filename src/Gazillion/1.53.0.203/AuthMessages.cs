...
namespace Gazillion {
  ...
  public static partial class AuthMessages {
    ...
    internal static pbd::MessageDescriptor internal__static_Gazillion_AcceptDocumentsResponse__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::Gazillion.AcceptDocumentsResponse, global::Gazillion.AcceptDocumentsResponse.Builder> internal__static_Gazillion_AcceptDocumentsResponse__FieldAccessorTable;
    #endregion
    #region Descriptor
    ...
    static AuthMessages() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "EhIKBGJvZHkYAyABKAlSBGJvZHkiwAsKCkF1dGhUaWNrZXQSHgoKc2Vzc2lv", 
            ...
            "cUFjY2VwdERvY3MSMQoSc2hvd1N0b3JlSGlnaGxpZ2h0GCIgASgDOgEwUhJz", 
            "aG93U3RvcmVIaWdobGlnaHQSIwoLYWNjb3VudFJhbmsYICABKAU6ATBSC2Fj", 
            "Y291bnRSYW5rEi0KEGFjY291bnRSYW5rU2NvcmUYISABKAM6ATBSEGFjY291", 
            "bnRSYW5rU2NvcmUSMgoUdm9pY2VDaGF0SXNFbmNyeXB0ZWQYHSABKAhSFHZv", 
            "aWNlQ2hhdElzRW5jcnlwdGVkEjAKE2dhbWVEYXRhSXNFbmNyeXB0ZWQYHiAB", 
            "KAhSE2dhbWVEYXRhSXNFbmNyeXB0ZWQSHgoKaHR0cFJlc3VsdBgfIAEoBVIK", 
            "aHR0cFJlc3VsdCKRAgojQ29uc29sZUNyZWF0ZUFjY291bnRNZXNzYWdlUmVz", 
            "cG9uc2USPAoJZXJyb3JDb2RlGAEgASgOMh4uR2F6aWxsaW9uLkF1dGhTZXJ2", 
            "ZXJFcnJvckNvZGVSCWVycm9yQ29kZRIaCghlcnJvck1zZxgCIAEoCVIIZXJy", 
            "b3JNc2cSKAoPbmFtZVN1Z2dlc3Rpb25zGAMgAygJUg9uYW1lU3VnZ2VzdGlv", 
            "bnMSRgoQcHJlUmVxQWNjZXB0RG9jcxgEIAMoCzIaLkdhemlsbGlvbi5BdXRo", 
            "UmVxdWlyZWREb2NSEHByZVJlcUFjY2VwdERvY3MSHgoKaHR0cFJlc3VsdBgF", 
            "IAEoBVIKaHR0cFJlc3VsdCJCCh5QcmVjYWNoZUhlYWRlcnNNZXNzYWdlUmVz", 
            "cG9uc2USIAoLcHJlY2FjaGVVcmwYASADKAlSC3ByZWNhY2hlVXJsIpoBChNO", 
            "ZXdzTWVzc2FnZVJlc3BvbnNlEkAKCm5ld3NMYXlvdXQYASACKAsyIC5HYXpp", 
            "bGxpb24uTUhMb2NhbGl6ZWROZXdzTGF5b3V0UgpuZXdzTGF5b3V0EkEKC25l", 
            "d3NFbnRyaWVzGAIgAygLMh8uR2F6aWxsaW9uLk1ITG9jYWxpemVkTmV3c0Vu", 
            "dHJ5UgtuZXdzRW50cmllcyJdChVNSExvY2FsaXplZE5ld3NMYXlvdXQSIgoM", 
            "bGF5b3V0SGVpZ2h0GAEgAigFUgxsYXlvdXRIZWlnaHQSIAoLbGF5b3V0V2lk", 
            "dGgYAiACKAVSC2xheW91dFdpZHRoIqIDChRNSExvY2FsaXplZE5ld3NFbnRy", 
            "eRImCg5pdGVtRGlzcGxheVVybBgBIAEoCVIOaXRlbURpc3BsYXlVcmwSHAoJ", 
            "aXRlbU9yZGVyGAIgAigFUglpdGVtT3JkZXISQAobYWN0aW9uTGlua1NhbGVh", 
            "YmxlT2JqZWN0U2t1GAMgASgJUhthY3Rpb25MaW5rU2FsZWFibGVPYmplY3RT", 
            "a3USLgoSYWN0aW9uTGlua0NhdGVnb3J5GAQgASgJUhJhY3Rpb25MaW5rQ2F0", 
            "ZWdvcnkSHgoKaXRlbUhlaWdodBgFIAEoBVIKaXRlbUhlaWdodBIcCglpdGVt", 
            "V2lkdGgYBiABKAVSCWl0ZW1XaWR0aBIkCg1hY3Rpb25MaW5rVXJsGAcgASgJ", 
            "Ug1hY3Rpb25MaW5rVXJsEjQKFWV4dGVybmFsU3RvcmVMaW5rTW9kZRgIIAEo", 
            "CVIVZXh0ZXJuYWxTdG9yZUxpbmtNb2RlEjgKF2V4dGVybmFsU3RvcmVMaW5r", 
            "VGFyZ2V0GAkgASgJUhdleHRlcm5hbFN0b3JlTGlua1RhcmdldCI5ChdBY2Nl", 
            "cHREb2N1bWVudHNSZXNwb25zZRIeCgpodHRwUmVzdWx0GAEgASgFUgpodHRw", 
            "UmVzdWx0KoUBChNBdXRoU2VydmVyRXJyb3JDb2RlEhYKEkFVVEhfRVJST1Jf", 
            "VU5LTk9XThAAEhYKEkFVVEhfRVJST1JfU1VDQ0VTUxABEh0KGUFVVEhfRVJS", 
            "T1JfQUNDT1VOVF9FWElTVFMQAhIfChtBVVRIX0VSUk9SX1BMQVlFUk5BTUVf", 
          "SU5VU0UQAw=="));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_Gazillion_ConsoleCreateAccountMessageResponse__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.ConsoleCreateAccountMessageResponse, global::Gazillion.ConsoleCreateAccountMessageResponse.Builder>(internal__static_Gazillion_ConsoleCreateAccountMessageResponse__Descriptor,
                new string[] { "ErrorCode", "ErrorMsg", "NameSuggestions", "PreReqAcceptDocs", "HttpResult", });
        ...
        internal__static_Gazillion_MHLocalizedNewsEntry__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.MHLocalizedNewsEntry, global::Gazillion.MHLocalizedNewsEntry.Builder>(internal__static_Gazillion_MHLocalizedNewsEntry__Descriptor,
                new string[] { "ItemDisplayUrl", "ItemOrder", "ActionLinkSaleableObjectSku", "ActionLinkCategory", "ItemHeight", "ItemWidth", "ActionLinkUrl", "ExternalStoreLinkMode", "ExternalStoreLinkTarget", });
        internal__static_Gazillion_AcceptDocumentsResponse__Descriptor = Descriptor.MessageTypes[7];
        internal__static_Gazillion_AcceptDocumentsResponse__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Gazillion.AcceptDocumentsResponse, global::Gazillion.AcceptDocumentsResponse.Builder>(internal__static_Gazillion_AcceptDocumentsResponse__Descriptor,
                new string[] { "HttpResult", });
  ...
  public sealed partial class AuthTicket : pb::GeneratedMessage<AuthTicket, AuthTicket.Builder> {
    ...
    private static readonly string[] _authTicketFieldNames = new string[] { "accountRank", "accountRankScore", "ageRestrictionEndTimeUtc", "ageRestrictionType", "ageRestrictionWarningTimeUtc1", "ageRestrictionWarningTimeUtc2", "ageRestrictionWarningTimeUtc3", "continentCode", "countryCode", "errorMessage", "frontendPort", "frontendServer", "gameDataIsEncrypted", "hasPendingGift", "hasVerifiedEmail", "hasnews", "httpResult", "isAgeRestrictionEnabled", "isAllowedToChat", "newsurl", "pendingGiftUrl", "platformTicket", "preReqAcceptDocs", "preReqCreateAccount", "preReqRenamePlayer", "presalePurchase", "sessionId", "sessionKey", "sessionToken", "showStoreHighlight", "success", "tosurl", "voiceChatIsEncrypted" };
    private static readonly uint[] _authTicketFieldTags = new uint[] { 256, 264, 152, 170, 160, 176, 184, 202, 194, 34, 50, 42, 240, 112, 128, 96, 248, 144, 136, 106, 122, 58, 226, 208, 216, 64, 24, 10, 18, 272, 80, 74, 232 };
    ...
    public const int ShowStoreHighlightFieldNumber = 34;
    private bool hasShowStoreHighlight;
    private long showStoreHighlight_;
    public bool HasShowStoreHighlight {
      get { return hasShowStoreHighlight; }
    }
    public long ShowStoreHighlight {
      get { return showStoreHighlight_; }
    }
    
    public const int AccountRankFieldNumber = 32;
    private bool hasAccountRank;
    private int accountRank_;
    ...
    public const int AccountRankScoreFieldNumber = 33;
    private bool hasAccountRankScore;
    private long accountRankScore_;
    ...
    public const int VoiceChatIsEncryptedFieldNumber = 29;
    private bool hasVoiceChatIsEncrypted;
    private bool voiceChatIsEncrypted_;
    public bool HasVoiceChatIsEncrypted {
      get { return hasVoiceChatIsEncrypted; }
    }
    public bool VoiceChatIsEncrypted {
      get { return voiceChatIsEncrypted_; }
    }
    
    public const int GameDataIsEncryptedFieldNumber = 30;
    private bool hasGameDataIsEncrypted;
    private bool gameDataIsEncrypted_;
    public bool HasGameDataIsEncrypted {
      get { return hasGameDataIsEncrypted; }
    }
    public bool GameDataIsEncrypted {
      get { return gameDataIsEncrypted_; }
    }
    
    public const int HttpResultFieldNumber = 31;
    private bool hasHttpResult;
    private int httpResult_;
    public bool HasHttpResult {
      get { return hasHttpResult; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasSessionKey) {
        output.WriteBytes(1, field_names[27], SessionKey);
      }
      if (hasSessionToken) {
        output.WriteBytes(2, field_names[28], SessionToken);
      }
      if (hasSessionId) {
        output.WriteUInt64(3, field_names[26], SessionId);
      }
      if (hasErrorMessage) {
        output.WriteString(4, field_names[9], ErrorMessage);
      }
      if (hasFrontendServer) {
        output.WriteString(5, field_names[11], FrontendServer);
      }
      if (hasFrontendPort) {
        output.WriteString(6, field_names[10], FrontendPort);
      }
      if (hasPlatformTicket) {
        output.WriteString(7, field_names[21], PlatformTicket);
      }
      if (hasPresalePurchase) {
        output.WriteBool(8, field_names[25], PresalePurchase);
      }
      if (hasTosurl) {
        output.WriteString(9, field_names[31], Tosurl);
      }
      if (hasSuccess) {
        output.WriteBool(10, field_names[30], Success);
      }
      if (hasHasnews) {
        output.WriteBool(12, field_names[15], Hasnews);
      }
      if (hasNewsurl) {
        output.WriteString(13, field_names[19], Newsurl);
      }
      if (hasHasPendingGift) {
        output.WriteBool(14, field_names[13], HasPendingGift);
      }
      if (hasPendingGiftUrl) {
        output.WriteString(15, field_names[20], PendingGiftUrl);
      }
      if (hasHasVerifiedEmail) {
        output.WriteBool(16, field_names[14], HasVerifiedEmail);
      }
      if (hasIsAllowedToChat) {
        output.WriteBool(17, field_names[18], IsAllowedToChat);
      }
      if (hasIsAgeRestrictionEnabled) {
        output.WriteBool(18, field_names[17], IsAgeRestrictionEnabled);
      }
      if (hasAgeRestrictionEndTimeUtc) {
        output.WriteInt64(19, field_names[2], AgeRestrictionEndTimeUtc);
      }
      if (hasAgeRestrictionWarningTimeUtc1) {
        output.WriteInt64(20, field_names[4], AgeRestrictionWarningTimeUtc1);
      }
      if (hasAgeRestrictionType) {
        output.WriteString(21, field_names[3], AgeRestrictionType);
      }
      if (hasAgeRestrictionWarningTimeUtc2) {
        output.WriteInt64(22, field_names[5], AgeRestrictionWarningTimeUtc2);
      }
      if (hasAgeRestrictionWarningTimeUtc3) {
        output.WriteInt64(23, field_names[6], AgeRestrictionWarningTimeUtc3);
      }
      if (hasCountryCode) {
        output.WriteString(24, field_names[8], CountryCode);
      }
      if (hasContinentCode) {
        output.WriteString(25, field_names[7], ContinentCode);
      }
      if (hasPreReqCreateAccount) {
        output.WriteBool(26, field_names[23], PreReqCreateAccount);
      }
      if (hasPreReqRenamePlayer) {
        output.WriteBool(27, field_names[24], PreReqRenamePlayer);
      }
      if (preReqAcceptDocs_.Count > 0) {
        output.WriteMessageArray(28, field_names[22], preReqAcceptDocs_);
      }
      if (hasVoiceChatIsEncrypted) {
        output.WriteBool(29, field_names[32], VoiceChatIsEncrypted);
      }
      if (hasGameDataIsEncrypted) {
        output.WriteBool(30, field_names[12], GameDataIsEncrypted);
      }
      if (hasHttpResult) {
        output.WriteInt32(31, field_names[16], HttpResult);
      }
      if (hasAccountRank) {
        output.WriteInt32(32, field_names[0], AccountRank);
      }
      if (hasAccountRankScore) {
        output.WriteInt64(33, field_names[1], AccountRankScore);
      }
      if (hasShowStoreHighlight) {
        output.WriteInt64(34, field_names[29], ShowStoreHighlight);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasShowStoreHighlight) {
        size += pb::CodedOutputStream.ComputeInt64Size(34, ShowStoreHighlight);
      }
      if (hasAccountRank) {
        size += pb::CodedOutputStream.ComputeInt32Size(32, AccountRank);
      }
      if (hasAccountRankScore) {
        size += pb::CodedOutputStream.ComputeInt64Size(33, AccountRankScore);
      }
      if (hasVoiceChatIsEncrypted) {
        size += pb::CodedOutputStream.ComputeBoolSize(29, VoiceChatIsEncrypted);
      }
      if (hasGameDataIsEncrypted) {
        size += pb::CodedOutputStream.ComputeBoolSize(30, GameDataIsEncrypted);
      }
      if (hasHttpResult) {
        size += pb::CodedOutputStream.ComputeInt32Size(31, HttpResult);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<AuthTicket, Builder> {
      ...
      public override Builder MergeFrom(AuthTicket other) {
        ...
        if (other.HasShowStoreHighlight) {
          ShowStoreHighlight = other.ShowStoreHighlight;
        }
        ...
        if (other.HasVoiceChatIsEncrypted) {
          VoiceChatIsEncrypted = other.VoiceChatIsEncrypted;
        }
        if (other.HasGameDataIsEncrypted) {
          GameDataIsEncrypted = other.GameDataIsEncrypted;
        }
        if (other.HasHttpResult) {
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 232: {
              result.hasVoiceChatIsEncrypted = input.ReadBool(ref result.voiceChatIsEncrypted_);
              break;
            }
            case 240: {
              result.hasGameDataIsEncrypted = input.ReadBool(ref result.gameDataIsEncrypted_);
              break;
            }
            case 248: {
              result.hasHttpResult = input.ReadInt32(ref result.httpResult_);
              break;
            }
            case 256: {
              result.hasAccountRank = input.ReadInt32(ref result.accountRank_);
              break;
            }
            case 264: {
            ...
            case 272: {
              result.hasShowStoreHighlight = input.ReadInt64(ref result.showStoreHighlight_);
              break;
            }
          }
        }
      ...
      public bool HasShowStoreHighlight {
        get { return result.hasShowStoreHighlight; }
      }
      public long ShowStoreHighlight {
        get { return result.ShowStoreHighlight; }
        set { SetShowStoreHighlight(value); }
      }
      public Builder SetShowStoreHighlight(long value) {
        PrepareBuilder();
        result.hasShowStoreHighlight = true;
        result.showStoreHighlight_ = value;
        return this;
      }
      public Builder ClearShowStoreHighlight() {
        PrepareBuilder();
        result.hasShowStoreHighlight = false;
        result.showStoreHighlight_ = 0L;
        return this;
      }
      ...
      public Builder SetAccountRank(int value) {
        PrepareBuilder();
      ...
      public Builder ClearAccountRankScore() {
        ...
        result.accountRankScore_ = 0L;
        return this;
      }
      
      public bool HasVoiceChatIsEncrypted {
        get { return result.hasVoiceChatIsEncrypted; }
      }
      public bool VoiceChatIsEncrypted {
        get { return result.VoiceChatIsEncrypted; }
        set { SetVoiceChatIsEncrypted(value); }
      }
      public Builder SetVoiceChatIsEncrypted(bool value) {
        PrepareBuilder();
        result.hasVoiceChatIsEncrypted = true;
        result.voiceChatIsEncrypted_ = value;
        return this;
      }
      public Builder ClearVoiceChatIsEncrypted() {
        PrepareBuilder();
        result.hasVoiceChatIsEncrypted = false;
        result.voiceChatIsEncrypted_ = false;
        return this;
      }
      
      public bool HasGameDataIsEncrypted {
        get { return result.hasGameDataIsEncrypted; }
      }
      public bool GameDataIsEncrypted {
        get { return result.GameDataIsEncrypted; }
        set { SetGameDataIsEncrypted(value); }
      }
      public Builder SetGameDataIsEncrypted(bool value) {
        PrepareBuilder();
        result.hasGameDataIsEncrypted = true;
        result.gameDataIsEncrypted_ = value;
        return this;
      }
      public Builder ClearGameDataIsEncrypted() {
        PrepareBuilder();
        result.hasGameDataIsEncrypted = false;
        result.gameDataIsEncrypted_ = false;
        return this;
      }
      
      public bool HasHttpResult {
        get { return result.hasHttpResult; }
      }
      public int HttpResult {
        get { return result.HttpResult; }
        set { SetHttpResult(value); }
      }
      public Builder SetHttpResult(int value) {
        PrepareBuilder();
        result.hasHttpResult = true;
        result.httpResult_ = value;
        return this;
      }
      public Builder ClearHttpResult() {
        PrepareBuilder();
        result.hasHttpResult = false;
        result.httpResult_ = 0;
        return this;
      }
    }
    static AuthTicket() {
  ...
  public sealed partial class ConsoleCreateAccountMessageResponse : pb::GeneratedMessage<ConsoleCreateAccountMessageResponse, ConsoleCreateAccountMessageResponse.Builder> {
    ...
    private static readonly string[] _consoleCreateAccountMessageResponseFieldNames = new string[] { "errorCode", "errorMsg", "httpResult", "nameSuggestions", "preReqAcceptDocs" };
    private static readonly uint[] _consoleCreateAccountMessageResponseFieldTags = new uint[] { 8, 18, 40, 26, 34 };
    ...
    public const int HttpResultFieldNumber = 5;
    private bool hasHttpResult;
    private int httpResult_;
    public bool HasHttpResult {
      get { return hasHttpResult; }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (nameSuggestions_.Count > 0) {
        output.WriteStringArray(3, field_names[3], nameSuggestions_);
      }
      if (preReqAcceptDocs_.Count > 0) {
        output.WriteMessageArray(4, field_names[4], preReqAcceptDocs_);
      }
      if (hasHttpResult) {
        output.WriteInt32(5, field_names[2], HttpResult);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasHttpResult) {
        size += pb::CodedOutputStream.ComputeInt32Size(5, HttpResult);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
  ...
  public sealed partial class MHLocalizedNewsEntry : pb::GeneratedMessage<MHLocalizedNewsEntry, MHLocalizedNewsEntry.Builder> {
    ...
    private static readonly string[] _mHLocalizedNewsEntryFieldNames = new string[] { "actionLinkCategory", "actionLinkSaleableObjectSku", "actionLinkUrl", "externalStoreLinkMode", "externalStoreLinkTarget", "itemDisplayUrl", "itemHeight", "itemOrder", "itemWidth" };
    private static readonly uint[] _mHLocalizedNewsEntryFieldTags = new uint[] { 34, 26, 58, 66, 74, 10, 40, 16, 48 };
    ...
    public const int ExternalStoreLinkModeFieldNumber = 8;
    ...
    public const int ExternalStoreLinkTargetFieldNumber = 9;
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasItemDisplayUrl) {
        output.WriteString(1, field_names[5], ItemDisplayUrl);
      }
      if (hasItemOrder) {
        output.WriteInt32(2, field_names[7], ItemOrder);
      }
      ...
      if (hasItemHeight) {
        output.WriteInt32(5, field_names[6], ItemHeight);
      }
      if (hasItemWidth) {
        output.WriteInt32(6, field_names[8], ItemWidth);
      }
      if (hasActionLinkUrl) {
        output.WriteString(7, field_names[2], ActionLinkUrl);
      }
      if (hasExternalStoreLinkMode) {
        output.WriteString(8, field_names[3], ExternalStoreLinkMode);
      }
      if (hasExternalStoreLinkTarget) {
        output.WriteString(9, field_names[4], ExternalStoreLinkTarget);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      if (hasExternalStoreLinkMode) {
        size += pb::CodedOutputStream.ComputeStringSize(8, ExternalStoreLinkMode);
      }
      if (hasExternalStoreLinkTarget) {
        size += pb::CodedOutputStream.ComputeStringSize(9, ExternalStoreLinkTarget);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
  ...
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  public sealed partial class AcceptDocumentsResponse : pb::GeneratedMessage<AcceptDocumentsResponse, AcceptDocumentsResponse.Builder> {
    private AcceptDocumentsResponse() { }
    private static readonly AcceptDocumentsResponse defaultInstance = new AcceptDocumentsResponse().MakeReadOnly();
    private static readonly string[] _acceptDocumentsResponseFieldNames = new string[] { "httpResult" };
    private static readonly uint[] _acceptDocumentsResponseFieldTags = new uint[] { 8 };
    public static AcceptDocumentsResponse DefaultInstance {
      get { return defaultInstance; }
    }
    
    public override AcceptDocumentsResponse DefaultInstanceForType {
      get { return DefaultInstance; }
    }
    
    protected override AcceptDocumentsResponse ThisMessage {
      get { return this; }
    }
    
    public static pbd::MessageDescriptor Descriptor {
      get { return global::Gazillion.AuthMessages.internal__static_Gazillion_AcceptDocumentsResponse__Descriptor; }
    }
    
    protected override pb::FieldAccess.FieldAccessorTable<AcceptDocumentsResponse, AcceptDocumentsResponse.Builder> InternalFieldAccessors {
      get { return global::Gazillion.AuthMessages.internal__static_Gazillion_AcceptDocumentsResponse__FieldAccessorTable; }
    }
    
    public const int HttpResultFieldNumber = 1;
    private bool hasHttpResult;
    private int httpResult_;
    public bool HasHttpResult {
      get { return hasHttpResult; }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      CalcSerializedSize();
      string[] field_names = _acceptDocumentsResponseFieldNames;
      if (hasHttpResult) {
        output.WriteInt32(1, field_names[0], HttpResult);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    private int CalcSerializedSize() {
      ...
      size = 0;
      if (hasHttpResult) {
        size += pb::CodedOutputStream.ComputeInt32Size(1, HttpResult);
      }
      size += UnknownFields.SerializedSize;
      memoizedSerializedSize = size;
      return size;
    }
    public static AcceptDocumentsResponse ParseFrom(pb::ByteString data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(pb::ByteString data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(byte[] data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(byte[] data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(global::System.IO.Stream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseDelimitedFrom(global::System.IO.Stream input) {
      return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseDelimitedFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(pb::ICodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static AcceptDocumentsResponse ParseFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    private AcceptDocumentsResponse MakeReadOnly() {
      return this;
    }
    ...
    public override Builder ToBuilder() { return CreateBuilder(this); }
    public override Builder CreateBuilderForType() { return new Builder(); }
    public static Builder CreateBuilder(AcceptDocumentsResponse prototype) {
      return new Builder(prototype);
    }
    
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    public sealed partial class Builder : pb::GeneratedBuilder<AcceptDocumentsResponse, Builder> {
      protected override Builder ThisBuilder {
        get { return this; }
      }
      public Builder() {
      ...
      internal Builder(AcceptDocumentsResponse cloneFrom) {
        result = cloneFrom;
        resultIsReadOnly = true;
      }
      
      private bool resultIsReadOnly;
      private AcceptDocumentsResponse result;
      
      private AcceptDocumentsResponse PrepareBuilder() {
        if (resultIsReadOnly) {
          AcceptDocumentsResponse original = result;
          result = new AcceptDocumentsResponse();
          resultIsReadOnly = false;
          MergeFrom(original);
        }
        return result;
      ...
      protected override AcceptDocumentsResponse MessageBeingBuilt {
        get { return PrepareBuilder(); }
      }
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::Gazillion.AcceptDocumentsResponse.Descriptor; }
      }
      
      public override AcceptDocumentsResponse DefaultInstanceForType {
        get { return global::Gazillion.AcceptDocumentsResponse.DefaultInstance; }
      }
      
      public override AcceptDocumentsResponse BuildPartial() {
        if (resultIsReadOnly) {
          return result;
        }
        resultIsReadOnly = true;
      ...
      public override Builder MergeFrom(pb::IMessage other) {
        if (other is AcceptDocumentsResponse) {
          return MergeFrom((AcceptDocumentsResponse) other);
        } else {
          base.MergeFrom(other);
          return this;
        }
      ...
      public override Builder MergeFrom(AcceptDocumentsResponse other) {
        if (other == global::Gazillion.AcceptDocumentsResponse.DefaultInstance) return this;
        PrepareBuilder();
        if (other.HasHttpResult) {
          HttpResult = other.HttpResult;
        }
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          if(tag == 0 && field_name != null) {
            int field_ordinal = global::System.Array.BinarySearch(_acceptDocumentsResponseFieldNames, field_name, global::System.StringComparer.Ordinal);
            if(field_ordinal >= 0)
              tag = _acceptDocumentsResponseFieldTags[field_ordinal];
            else {
              if (unknownFields == null) {
                unknownFields = pb::UnknownFieldSet.CreateBuilder(this.UnknownFields);
              }
    ...
    static AcceptDocumentsResponse() {
      object.ReferenceEquals(global::Gazillion.AuthMessages.Descriptor, null);
    }
  }
